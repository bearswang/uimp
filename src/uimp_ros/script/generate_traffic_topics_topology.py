    ...
    for waypoints in set_waypoints:
        ...
        if not waypoint.is_junction:
            ...
            if straight_road == 1 and boundary_road == 1:
                ...
                pdd_obstacles.obstacles.append(obstacle)
...
if __name__ == "__main__":
    ...
    try:
        ...
        obs_pub = rospy.Publisher("pdd_obstacles", ObstacleArrayMsg, queue_size=10)

        rate = rospy.Rate(50)

        pdd_obstacles = ObstacleArrayMsg()

        while not rospy.is_shutdown():
            world.wait_for_tick()

            pdd_obstacles.header = Header(stamp=rospy.Time.now(), frame_id="map")
            pdd_obstacles.obstacles = []
